    ...
    subscribe: function () {
      document
        ...
        .addEventListener("submit", function (event) {
          ...
          // Set the subject and message dynamically
          formData.append("subject", "Subscription"); // Add subject
          formData.append("message", `For news letter subscription: ${email}`); // Add message

          // Send the form data using fetch (Formspree's POST endpoint)
          fetch(this.action, {
            method: "POST",
            body: formData,
            headers: {
            ...
            .then((response) => {
              ...
              if (response.ok) {
                ...
                document.getElementById("subscribe-form").reset(); // Clears the form fields
              } else {
          ...
          fetch(this.action, {
            ...
            .then((response) => {
              if (response.ok) {
                ...
                // document.querySelector('.contact-form-result').style.display = 'block'; // Show the success message
              } else {
